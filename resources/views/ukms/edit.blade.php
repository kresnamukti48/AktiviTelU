      ...
      <form action="{{ route('ukms.update', $ukm->id) }}" method="post" enctype="multipart/form-data">  
        ...
        <div class="form-group">  
          ...
          <select class="form-control @error('kategori_ukm') is-invalid @enderror" name="kategori_ukm" id="kategori_ukm">  
            ...
            <option value="kesenian" {{ (old('kategori_ukm') ?? $ukm->kategori_ukm) == 'kesenian' ? 'selected' : '' }}>Kesenian</option>  
            <option value="sosial" {{ (old('kategori_ukm') ?? $ukm->kategori_ukm) == 'sosial' ? 'selected' : '' }}>Sosial</option>  
            <option value="penalaran" {{ (old('kategori_ukm') ?? $ukm->kategori_ukm) == 'penalaran' ? 'selected' : '' }}>Penalaran</option>  
            <option value="olahraga" {{ (old('kategori_ukm') ?? $ukm->kategori_ukm) == 'olahraga' ? 'selected' : '' }}>Olahraga</option>  
            <option value="kerohanian" {{ (old('kategori_ukm') ?? $ukm->kategori_ukm) == 'kerohanian' ? 'selected' : '' }}>Kerohanian</option>  
          </select>  
          @error('kategori_ukm')  
            <span class="text-danger">{{ $message }}</span>  
          @enderror  
        ...
        <div class="form-group">  
          ...
          <input type="text" class="form-control @error('instagram_ukm') is-invalid @enderror" name="instagram_ukm" id="instagram_ukm" placeholder="Instagram" autocomplete="off" value="{{ old('instagram_ukm') ?? $ukm->instagram_ukm }}">  
          @error('instagram_ukm')  
            <span class="text-danger">{{ $message }}</span>  
          @enderror  
        </div>  
        ...
        <div class="form-group">  
          ...
          <input type="email_ukm" class="form-control @error('email_ukm') is-invalid @enderror" name="email_ukm" id="email_ukm" placeholder="Email" autocomplete="off" value="{{ old('email_ukm') ?? $ukm->email_ukm }}">  
          @error('email_ukm')  
            <span class="text-danger">{{ $message }}</span>  
          @enderror  
        </div>  
