        ...
        <div class="card-body">
            <form action="{{ route('basic.update', $user->id) }}" method="post">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control @error('no_telepon') is-invalid @enderror" no_telepon="no_telepon" id="no_telepon" placeholder="Nomor Telepon" autocomplete="off" value="{{ old('no_telepon') ?? $user->no_telepon }}">
                  @error('no_telepon')
                    <span class="text-danger">{{ $message }}</span>
                  @enderror
                </div>
